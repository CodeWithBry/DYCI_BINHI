import { research } from "./pageComponents.js";

const imageContainer = research.querySelector(".images-container");
const images = imageContainer.querySelectorAll(".image");
const indicators = research.querySelectorAll(".indicator");
