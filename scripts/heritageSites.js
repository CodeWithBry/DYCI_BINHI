import { heritage_sites } from "./pageComponents.js";

const imageContainer = heritage_sites.querySelector(".images-container");
const images = imageContainer.querySelectorAll(".image");
const indicators = heritage_sites.querySelectorAll(".indicator");
