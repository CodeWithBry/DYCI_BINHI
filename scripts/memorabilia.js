import { memorabilia } from "./pageComponents.js";

const imageContainer = memorabilia.querySelector(".images-container");
const images = imageContainer.querySelectorAll(".image");
const indicators = memorabilia.querySelectorAll(".indicator");
